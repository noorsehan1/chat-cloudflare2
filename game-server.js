// ==================== GAME SERVER - FULL CODE (TANPA DOUBLE START) ====================
...
export class GameServer {
  constructor(state, env) {
    ...
    // ✅ FLAG UNTUK MENCEGAH DOUBLE START
  ...
  _startDrawPhase(room, game) {
    try {
      ...
      // ✅ CEK JUMLAH PLAYER, JANGAN TAMBAH BOT LAGI
